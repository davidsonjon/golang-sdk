...
func NewWorkgroupDeleteItem(id string, status int) *WorkgroupDeleteItem {
...
func (o *WorkgroupDeleteItem) GetStatus() int {
	if o == nil {
		var ret int
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WorkgroupDeleteItem) GetStatusOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WorkgroupDeleteItem) SetStatus(v int) {
	o.Status = v
}
