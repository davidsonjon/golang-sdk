...
func NewWorkgroupMemberAddItem(id string, status int) *WorkgroupMemberAddItem {
...
func (o *WorkgroupMemberAddItem) GetStatus() int {
	if o == nil {
		var ret int
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WorkgroupMemberAddItem) GetStatusOk() (*int, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WorkgroupMemberAddItem) SetStatus(v int) {
	o.Status = v
}
